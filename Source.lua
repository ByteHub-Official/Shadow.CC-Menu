...
function Luxt1.CreateWindow(libName, logoId)
    ...
    key1.Text = "LeftAlt"
    key1.TextColor3 = Color3.fromRGB(255, 70, 70)
    ...
    hubLogo.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
    ...
    hubName.TextColor3 = Color3.fromRGB(255, 70, 70)
    ...
    usename.TextColor3 = Color3.fromRGB(220, 100, 100)
    ...
    wave.ImageColor3 = Color3.fromRGB(255, 120, 120)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(255, 70, 70)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(255, 70, 70)
        --
                    ...
                    for i,v in next, v:GetChildren() do
                        if v:IsA("TextButton") then
                            game.TweenService:Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                                TextColor3 = Color3.fromRGB(70, 30, 30)
                            }):Play()
                        end
                        if v:IsA("ImageLabel") then
                            game.TweenService:Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                                ImageColor3 = Color3.fromRGB(70, 30, 30)
                            }):Play()
                        end
                    end
                end
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(255, 70, 70)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(255, 70, 70)
                ...
                checkBtn.MouseButton1Click:Connect(function()
                    if not togDe then
                            ...
                            on = not on
                             callback(on) 
                            if on then
                                checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(255, 70, 70)
                                checkBtn.ImageColor3 = Color3.fromRGB(255, 70, 70)
            ...
            function ItemHandling:KeyBind(keyInfo, first, callback)
                ...
                key.Text = oldKey
                key.TextColor3 = Color3.fromRGB(255, 70, 70)
                key.TextSize = 14.000
            ...
            function ItemHandling:TextBox(infbix, textPlace, callback)
                ...
                TextBox.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
            ...
            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                ...
                dragSlider.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
            ...
            function ItemHandling:DropDown(dropInfo, list, callback)
                ...
                expand_more.ImageColor3 = Color3.fromRGB(255, 70, 70)
                ...
                dropdownItem1.TextColor3 = Color3.fromRGB(255, 70, 70)
                ...
                for i,v in next, list do
                    ...
                    optionBtn1.Text = "  "..v
                    optionBtn1.TextColor3 = Color3.fromRGB(200, 100, 100)
